...
export default function Onboarding() {
  const { belt, setBelt, styles, setStyles, goals, setGoals, freq, setFreq, comp, setComp, finishOnboarding } = useApp();
  ...
  const canNext=[nickname.trim().length>0,belt!=='',giPref!=='',styles.length>0,true,true,goals.length>0,freq!==''];
